...
BO_BytesArrayRef BO_BytesArrayCreate(size_t size);
BO_BytesArrayRef BO_BytesArrayCreateWithBytes(size_t size, const uint8_t* bytes);
...
size_t BO_BytesArraySize(BO_BytesArrayRef arr);
